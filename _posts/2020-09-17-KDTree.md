...
<table>
    ...
    <tr>
        <td>
            <div id="viewport1" style="width:20em; height:15em;">
            <iframe title="Demo" style="position: absolute; height: 100%; width: 65%;border: none" src="../../assets/data/vis_1_2A01A_2LEMA_FATCAT.html"></iframe>
            </div>
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>
            <div id="viewport2" style="width:20em; height:15em;">
            <iframe title="Demo" style="position: absolute; height: 100%; width: 65%;border: none" src="../../assets/data/vis_2_2A01A_2LEMA_FATCAT.html"></iframe>
            </div>
        </td>
    </tr>
</table>